...
scissorsPLayer.onclick = playerChoose(scissorsPLayer, playerArr, comArr, gameResult);
...
refreshGame.onclick = function(){
    ...
    if(isEnd){
        ...
        for(let i = 0; i < 3; i++){
            ...
            playerArr[i].onclick = playerChoose(playerArr[i], playerArr, comArr, gameResult);
